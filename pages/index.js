  ...
  return (
    <>
      <Head>
        ...
        <script 
          async 
          src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-7415807447932383"
          ...
          <div className="flex min-h-screen flex-col">
            ...
            <header className="sticky top-0 z-10 border-b border-slate-200/80 bg-background-light/80 backdrop-blur-sm dark:border-slate-800/80 dark:bg-background-dark/80">
              ...
              <a className="flex items-center gap-3 py-4" href="#">
                <img 
                  src="/images/logos/OnlyDans-Logo-Design-3.jpg" 
                  alt="OnlyDans" 
                    ...
                    <div className="divide-y divide-slate-200/80 dark:divide-slate-800/80">
                      {news.map((article) => (
                        <article key={article.id} className="flex gap-6 py-8">
                          <div className="h-24 w-32 flex-shrink-0 rounded-lg bg-gradient-to-br from-slate-100 to-slate-200 dark:from-slate-800 dark:to-slate-700 overflow-hidden">
                            {article.imageUrl ? (
                              <div className="h-full w-full relative">
                                <img
                                  ...
                                  onError={(e) => {
                                    // Fallback para placeholder se imagem falhar ao carregar
